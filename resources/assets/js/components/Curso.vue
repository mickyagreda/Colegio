                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      ...
                                      <option value="seccion">paralelo</option>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">dimension</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="dimension" class="form-control" >                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Paralelo</label>
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idParalelo">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="paralelo in arrayParalelo" :key="paralelo.id" :value="paralelo.id" v-text="paralelo.seccion"></option>
                                        </select>                                        
                                    </div>
                                </div>
...
<script>
    export default {
        ...
        methods : {
            ...
            activarCurso(id){
               swal({
                title: 'Esta seguro de activar este aula?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
            ...
            validarCurso(){
                ...
                if (!this.dimension) this.errorMostrarMsjCurso.push("La dimension del curso debe ser especificado y no puede estar vacío.");
                if (!this.idParalelo) this.errorMostrarMsjCurso.push("El el curso debe pertener a algun paralelo y no puede estar vacío.");
